...
| 02 | `02_string_ops.c` | Basic | strlen, strcpy, strcmp, strcat, strchr, memcpy, memset, memcmp | ❌ CRASH |
| 03 | `03_math_logic.c` | Basic | abs, min, max, clamp, swap, popcount, bsr, bsf, bswap | ⚠️ PARTIAL |
| 04 | `04_memory_alloc.c` | Intermediate | malloc, free, calloc, realloc patterns | ⚠️ PARTIAL |
| 05 | `05_control_flow.c` | Intermediate | if/else, for, while, switch, fibonacci, primes | ⚠️ PARTIAL |
