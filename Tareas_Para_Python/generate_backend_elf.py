...
def main():
    print("🔧 Generando backend/elf.rs...")
    path = BACKEND_PATH / "elf.rs"
    path.write_text(ELF_RS, encoding='utf-8')
    print(f"  ✅ elf.rs → {ELF_RS.count(chr(10))} líneas")
