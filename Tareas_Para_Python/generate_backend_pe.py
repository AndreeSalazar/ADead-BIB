...
impl PeBuilder {
    ...
    fn write_section(&self, pe: &mut Vec<u8>, name: &[u8], rva: u32, size: u32, 
        ...
        pe.extend_from_slice(&align_up(size as usize, FILE_ALIGNMENT as usize).to_le_bytes::<4>()); // SizeOfRawData
...
def main():
    print("🔧 Generando backend/pe.rs...")
    path = BACKEND_PATH / "pe.rs"
    path.write_text(PE_RS, encoding='utf-8')
    print(f"  ✅ pe.rs → {PE_RS.count(chr(10))} líneas")
