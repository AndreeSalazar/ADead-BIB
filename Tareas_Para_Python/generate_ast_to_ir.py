...
def main():
    print("🔧 Generando middle/ast_to_ir.rs...")
    path = MIDDLE_PATH / "ast_to_ir.rs"
    path.write_text(AST_TO_IR_RS, encoding='utf-8')
    print(f"  ✅ ast_to_ir.rs → {AST_TO_IR_RS.count(chr(10))} líneas")
