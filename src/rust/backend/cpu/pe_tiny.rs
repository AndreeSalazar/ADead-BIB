...
pub fn generate_pe_tiny(opcodes: &[u8], output_path: &str) -> Result<usize, Box<dyn std::error::Error>> {
    let mut pe = Vec::new();
...
pub fn generate_pe_nano(exit_code: u8, output_path: &str) -> Result<usize, Box<dyn std::error::Error>> {
...
pub fn generate_pe_ultra(exit_code: u8, output_path: &str) -> Result<usize, Box<dyn std::error::Error>> {
    let mut pe = Vec::new();
...
pub fn generate_pe_byte(opcodes: &[u8], output_path: &str) -> Result<usize, Box<dyn std::error::Error>> {
    if opcodes.len() > 100 {
    ...
    let size = pe.len();
    println!("✅ Byte PE generated: {} bytes (code: {} bytes)", size, opcodes.len());
...
pub fn generate_pe32_micro(exit_code: u8, output_path: &str) -> Result<usize, Box<dyn std::error::Error>> {
    let mut pe = Vec::new();
...
pub fn generate_flat_binary(opcodes: &[u8], output_path: &str) -> Result<usize, Box<dyn std::error::Error>> {
    let mut file = File::create(output_path)?;
