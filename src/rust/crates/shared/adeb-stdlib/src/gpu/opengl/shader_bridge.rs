...
impl PtxParser {
    ...
    fn parse_instruction(line: &str) -> Option<PtxInstruction> {
        ...
        match *opcode {
            ...
            "add" => Self::parse_binary_op(|ty, dst, src1, src2| PtxInstruction::Add { ty, dst, src1, src2 }, &parts),
            "sub" => Self::parse_binary_op(|ty, dst, src1, src2| PtxInstruction::Sub { ty, dst, src1, src2 }, &parts),
            "mul" => Self::parse_binary_op(|ty, dst, src1, src2| PtxInstruction::Mul { ty, dst, src1, src2 }, &parts),
            "div" => Self::parse_binary_op(|ty, dst, src1, src2| PtxInstruction::Div { ty, dst, src1, src2 }, &parts),
