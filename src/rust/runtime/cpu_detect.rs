...
impl CPUFeatures {
    ...
    pub fn print_summary(&self) {
        ...
        println!("║   AVX-512F: {} | AVX-512BW: {} | FMA: {}                    ║",
                 if self.has_avx512f { "✓" } else { "✗" },
                 if self.has_avx512bw { "✓" } else { "✗" },
                 if self.has_fma { "✓" } else { "✗" });
        println!("╠════════════════════════════════════════════════════════════╣");
        println!("║ Best SIMD: {:10} ({:3}-bit)                            ║", 
                 self.best_simd_name(), self.best_simd_width());
        println!("╠════════════════════════════════════════════════════════════╣");
        println!("║ Cache: L1d {:4}KB | L1i {:4}KB | L2 {:5}KB | L3 {:5}KB   ║",
