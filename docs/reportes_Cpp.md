...
|---|---|---|---|---|
| C++98 | 15 | 15 | 10 | ✅ ~67% funcional |
| C++11 | 14 | 14 | 8 | ✅ ~57% funcional |
| C++14 | 4 | 3 | 0 | ⚠️ ~0% (heredado de C++11) |
| C++17 | 11 | 11 | 1 | ⚠️ ~9% (if constexpr) |
| C++20 | 6 | 4 | 0 | ⚠️ Spaceship lowered |
...
ADead-BIB-Main:     56 tests — 0 fallos ✅ (incluye 10 fixtures C++)
adeb-frontend-c:   124 tests — 0 fallos ✅
Total:             223 tests — 0 fallos ✅
```
...
**Fase 1 y Fase 2 completadas.** El compilador C++ funciona end-to-end:
```
.cpp → CppPreprocessor → CppLexer → CppParser → UB Detector → CppToIR → Program IR
```

**El pipeline converge con C en `Program` IR** — ISA compiler y PE builder compartidos.

**Próximo:** Fase 3 (STL inline, templates, vtable) y Fase 4 (avanzado).

---

*ADead-BIB v8.0 — C++ Fase 2 Completa — Marzo 2026*  
*Eddi Andreé Salazar Matos — Lima, Perú*  
*Licencia: Techne v1.0 (τέχνη)*  
*"C++ ahora habla IR. Bits respetados. UB = error. 💀🦈"*
