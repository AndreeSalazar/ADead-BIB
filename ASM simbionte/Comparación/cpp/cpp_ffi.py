...
C++ FFI for Python
==================
Requiere compilar cpp_lib.cpp primero:
...
class CppLib:
    """Wrapper Python para librería C++ nativa"""
    
    def __init__(self, lib_path=None):
        self.lib_path = lib_path or os.path.join(os.path.dirname(__file__), "cpp_lib.dll")
