...
// ── DirectX / COM Headers ─────────────────────────────────
pub mod fastos_com;       // COM → CoInitializeEx, CoCreateInstance, IUnknown, HRESULT...
pub mod fastos_dxgi;      // DXGI → CreateDXGIFactory, IDXGISwapChain, DXGI_FORMAT...
pub mod fastos_d3d9;      // Direct3D 9 → Direct3DCreate9, IDirect3DDevice9...
pub mod fastos_d3d11;     // Direct3D 11 → D3D11CreateDevice, ID3D11Device, D3DCompile...
pub mod fastos_d3d12;     // Direct3D 12 → D3D12CreateDevice, ID3D12Device, raytracing...

// ── Platform API (Native C) ──────────────────────────────────
pub mod fastos_win32;    // Win32 API → kernel32, user32, gdi32, WGL
pub mod fastos_linux;    // Linux/POSIX → syscalls, pthreads, X11, Wayland, GLX
